      ...
      <div className="about-container" id="about">
        ...
        <div className="about-content-cont">
          <div className="font-size-main carousel-text-left">
            <p>In my downtime I enjoy weightlifting, hiking and camping with my wife Lauren and our pooch, Miso. I'm a lifelong Denver Broncos fan, and I love photography and spending time in nature. </p>
